...
public class TestMatrixPublic {
    ...
    @Test(timeout = 30000) //TLE (change timout back to 10000)
    ...
    public void testa4() throws Exception {
        String solution = Main.solve(grid4, "BF", true);
        solution = solution.replace(" ", "");
